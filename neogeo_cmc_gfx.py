...
def encrypt_cmc42_gfx(unencrypted_crom, game_specific_xor_seed):
    print("Encrypting graphics with original CMC42 encryption...")
    encrypted_addresses = gfx_change_address(unencrypted_crom, len(unencrypted_crom), game_specific_xor_seed, kof99_address_16_23_xor1, kof99_address_16_23_xor2, kof99_address_8_15_xor1, kof99_address_8_15_xor2, kof99_address_0_7_xor, True)
    return gfx_change_data(encrypted_addresses, len(unencrypted_crom), kof99_type0_t03, kof99_type0_t12, kof99_type1_t03, kof99_type1_t12, kof99_address_16_23_xor2, kof99_address_0_7_xor, True)

def decrypt_cmc42_gfx(encrypted_crom, game_specific_xor_seed):
    print("Decrypting graphics with CMC42 encryption...")
    unencrypted_data = gfx_change_data(encrypted_crom, len(encrypted_crom), kof99_type0_t03, kof99_type0_t12, kof99_type1_t03, kof99_type1_t12, kof99_address_16_23_xor2, kof99_address_0_7_xor, False)
    return gfx_change_address(unencrypted_data, len(encrypted_crom), game_specific_xor_seed, kof99_address_16_23_xor1, kof99_address_16_23_xor2, kof99_address_8_15_xor1, kof99_address_8_15_xor2, kof99_address_0_7_xor, False)
